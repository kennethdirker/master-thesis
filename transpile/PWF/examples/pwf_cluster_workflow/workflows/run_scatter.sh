...
python process_images_offline_scatter.py -y process_images_offline_scatter.yaml --outdir $OUTDIR --tmpdir $TMPDIR --preserve_tmp --dask --slurm_config slurm.config
